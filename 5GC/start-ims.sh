...
echo "[1/4] 启动 free5gc-ue-routes..."
systemctl restart free5gc-ue-routes.service
systemctl status free5gc-ue-routes.service --no-pager -l

echo "[2/4] 配置 IMS IP 地址..."
...
echo "[3/4] 启动 kamailio..."
systemctl restart kamailio.service
systemctl status kamailio.service --no-pager -l

echo "[4/4] 启动 free5gc-disable-offload..."
systemctl restart free5gc-disable-offload.service
